...
<body>
  <nav class="sidebar">
    <asp:HyperLink ID="siteLogoLink" runat="server" NavigateUrl="../customer/index.aspx" CssClass="site-logo">
...
<nav class="topbar">
    ...
    <div class="hamburger">
        ...
        <div class="nav-links">
            ...
            <div class="nav-link active"><i class="ri-bar-chart-fill"></i>Analytics</div>
                </asp:HyperLink>
